...
//		api.getDefaultCommander(FleetSide.PLAYER).getStats().setSkillLevel(Skills.ELECTRONIC_WARFARE, 3);
        ...
        if (!testMode) {
            ...
            api.addToFleet(FleetSide.PLAYER, "fs_HaiDeLa", FleetMemberType.SHIP, "海德拉", false);
            api.addToFleet(FleetSide.PLAYER, "fs_HaiShi", FleetMemberType.SHIP, "海使", false);
            api.addToFleet(FleetSide.PLAYER, "fs_HeiLang", FleetMemberType.SHIP, "黑狼", false);
            api.addToFleet(FleetSide.PLAYER, "fs_HeiYing", FleetMemberType.SHIP, "黑鹰", false);
            api.addToFleet(FleetSide.PLAYER, "fs_HeiZhu", FleetMemberType.SHIP, "黑蛛", false);
            api.addToFleet(FleetSide.PLAYER, "fs_MeiYing", FleetMemberType.SHIP, "魅影", false);
            api.addToFleet(FleetSide.PLAYER, "fs_RouLing", FleetMemberType.SHIP, "蹂躏", false);
            api.addToFleet(FleetSide.PLAYER, "fs_TianDun", FleetMemberType.SHIP, "天盾", false);
            api.addToFleet(FleetSide.PLAYER, "fs_XiuGu", FleetMemberType.SHIP, "锈骨", false);
            api.addToFleet(FleetSide.PLAYER, "fs_XiuShi", FleetMemberType.SHIP, "锈侍", false);
            api.addToFleet(FleetSide.PLAYER, "fs_XiuZhe", FleetMemberType.SHIP, "锈者", false);
            api.addToFleet(FleetSide.PLAYER, "fs_XiuZhong", FleetMemberType.SHIP, "锈种", false);
            api.addToFleet(FleetSide.PLAYER, "fs_ZhenZhu", FleetMemberType.SHIP, "珍珠", false);
            api.addToFleet(FleetSide.PLAYER, "fs_ZhuBei", FleetMemberType.SHIP, "珠贝", false);
